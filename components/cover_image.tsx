...
export function CoverImage() {
  return (
    <div className="relative z-0 flex min-h-screen justify-center bg-gradient-to-b from-[#dfe1ed] to-white dark:bg-none lg:left-16 lg:top-[7vh] lg:min-h-full lg:grow lg:bg-none xl:top-[10vh] xl:left-32">
